...
/// </summary>
/// <param name="_command">введенная строка</param>
/// <returns>является или не являедся командой</returns>
...
/// </summary>
/// <param name="_command">введенная команда</param>
/// <returns>Если такая команда существует вернет номер в массиве, иначе вернет -1</returns>
